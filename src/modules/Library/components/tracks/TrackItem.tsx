...
const TrackItem: React.FC<TrackItemProps> = ({
  ...
  return (
   <div className={`flex items-center justify-between p-2 rounded-lg hover:bg-base-300 transition-colors ${isPlaying ? 'bg-primary/20 border border-primary/30' : ''}`}>
...
//     if (currentFile?.id === file.id && !audioPlayback.isPaused()) {
//       audioPlayback.pause();
//     } else if (currentFile?.id === file.id && audioPlayback.isPaused()) {
